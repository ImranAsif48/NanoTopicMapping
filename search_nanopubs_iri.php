...
<html>
                            ...
                            <hr />
                                <div class="search-form">
                                        <div class="input-group">
                                            <input type="text" id="txtSearch" placeholder="Search IRI" name="search" class="form-control input-lg">
                                            &nbsp;
                                            <div class="input-group-btn">
                                                <button id="btnSearch" class="btn btn-primary" type="button" onclick="SearchTerm()">
                                                    Search
                                                </button>
                                            </div>
                                        </div>
    ...
    $(function() {
        ...
        source: function( request, response ) {
                ...
                if(document.getElementById('rdoIRI').checked || document.getElementById('rdoAll').checked)
                {
                    request.option = 'iri';
                    request.search = 'iri';
                    if ( term in cacheIRI ) {
            ...
            $('#page-selection').pagination({
                dataSource: function(done) {
                            $.ajax({
                                url: 'Code/' + pageName,
                                method: "POST",
                                data: { searchTerm : $('#txtSearch').val(), searchBy:'iri' },
                                dataType: "json",
